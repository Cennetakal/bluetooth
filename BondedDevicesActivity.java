...
public class BondedDevicesActivity extends AppCompatActivity {
    ...
    private Toolbar actionbarBonded;

    public void init(){
        actionbarBonded = (Toolbar) findViewById(R.id.actionbarBonded);
        setSupportActionBar(actionbarBonded);
        getSupportActionBar().setTitle("Daha Önceden Bağlanılmış Cihazlar");
